...
import { ArrowLeft, Upload, Image as ImageIcon, ChevronDown } from "lucide-react";
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-gray-200 p-8 sm:p-10">
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="space-y-2">
              ...
              <div
                className={`
                  ...
                  ${preview ? 'border-gray-200' : 'border-gray-300 hover:border-gray-900 hover:bg-gray-50'}
                `}
            ...
            <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-xl border border-gray-100">
              ...
              />
              <label htmlFor="availability" className="text-sm font-medium text-gray-900 cursor-pointer select-none">
                Available for sale
              </label>
            </div>
            ...
            <div className="pt-4 border-t border-gray-100">
              <h3 className="text-sm font-bold text-gray-900 mb-4">SEO Settings (Optional)</h3>
