...
export default function Footer() {
  return (
    <footer className="bg-white max-w-6xl mx-auto text-gray-900 py-20 border-t border-gray-200">
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 mt-16 pt-8 border-t border-gray-200">
